...
class DeclListNode extends ASTnode {
    ...
    public void codeGen(PrintWriter p) {
        for (int i = 0; i < myDecls.size(); i++) {
            if (myDecls.get(i) instanceof DeclNode) {
                myDecls.get(i).codeGen(p);
            }
        }
    }
...
class StmtListNode extends ASTnode {
    ...
    public void codeGen(PrintWriter p, String label) {
        for (int i = 0; i < myStmts.size(); i++) {
            if (myStmts.get(i) instanceof StmtNode) {
                myStmts.get(i).codeGen(p, label);
            }
        }
    }
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen(PrintWriter p) {
        ...
        if (!isMain) {
            ...
            if(myFormalsList.length() != 0) {
                myFormalsList.codeGen(p, myId.name());
            }
        }
        ...
        Codegen.generateWithComment("move", "", Codegen.SP, Codegen.T0);
        
        if (!myId.name().equals("main")) {
            Codegen.generate("jr", Codegen.RA);
        }
        else if(myId.name().equals("main")) {
...
abstract class StmtNode extends ASTnode {
    ...
    abstract public void codeGen(PrintWriter p, String label);
}
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        if (offset != 0) {
            ...
            Codegen.generate("lw", Codegen.T0, "." + ((IdNode)myExp).name());
            Codegen.generate("addi", Codegen.T0, Codegen.T0, 1);
            Codegen.generate("sw", Codegen.T0, "." + ((IdNode)myExp).name());
        }
    }
...
class ReadStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        Codegen.generateWithComment("syscall", "READ RETURN");
    }
...
class WriteStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        else if(myExp.typeCheck().isStringType()) {
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        String endOfIf = Codegen.nextLabel();
        Codegen.generate("beq", Codegen.T0, Codegen.Z0, endOfIf);
        myDeclList.codeGen(p);
        myStmtList.codeGen(p, label);
        
        Codegen.generateLabeled(endOfIf, "nop", "");
    }
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        String endOfIf = Codegen.nextLabel();
        String endOfElse = Codegen.nextLabel();
        
        Codegen.generate("beq", Codegen.T0, Codegen.Z0, endOfIf);
        myThenDeclList.codeGen(p);
        myThenStmtList.codeGen(p, label);
        Codegen.generate("j", endOfElse);
        
        Codegen.genLabel(endOfIf);
        myElseDeclList.codeGen(p);
        myElseStmtList.codeGen(p, label);
        
        Codegen.generateLabeled(endOfElse, "nop", "");
    }
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p, String label) {
        ...
        Codegen.generate("beq", Codegen.T0, Codegen.Z0, exitLabel);
        myDeclList.codeGen(p);
        myStmtList.codeGen(p, label);
        Codegen.generate("j", startLabel);
        
        Codegen.generateLabeled(exitLabel, "nop", "");
    }
...
class IdNode extends ExpNode {
    ...
    public void codeGen(PrintWriter p) {
        ...
        System.out.println(myStrVal + " offset: " + offset);
        if (offset != 0) {
            Codegen.generateIndexed("lw", Codegen.T0, Codegen.FP, offset);
            Codegen.genPush(Codegen.T0);
        }
...
class AssignNode extends ExpNode {
    ...
    public void codeGen(PrintWriter p) {
        ...
        if (myLhs instanceof IdNode) {;
            int offset = ((IdNode)myLhs).sym().getOffset();
            if (offset != 0) {
                Codegen.generateIndexed("sw", Codegen.T0, Codegen.FP, ((IdNode)myLhs).sym().getOffset(), "");
            }
            else {
                Codegen.generateWithComment("sw", "", Codegen.T0, "." + ((IdNode)myLhs).name());
            }
        }   
    }
...
class UnaryMinusNode extends UnaryExpNode {
    ...
    public void codeGen(PrintWriter p) {
        myExp.codeGen(p);
        Codegen.genPop(Codegen.T0);
        Codegen.generate("sub", Codegen.T0, Codegen.Z0, Codegen.T0);
        Codegen.genPush(Codegen.T0);
    }
...
class AndNode extends LogicalExpNode {
    ...
    public void codeGen(PrintWriter p) {
        ...
        String rightHandLabel = Codegen.nextLabel();
        String resLabel = Codegen.nextLabel();
        Codegen.generate("beq", Codegen.T0, Codegen.Z0, resLabel);
        
        Codegen.genLabel(rightHandLabel);
        myExp2.codeGen(p);
        Codegen.genPop(Codegen.T0);
        
        Codegen.genLabel(resLabel);
        Codegen.genPush(Codegen.T0);
    }
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen(PrintWriter p) {
        ...
        String rightHandLabel = Codegen.nextLabel();
        String resLabel = Codegen.nextLabel();
        Codegen.generate("bne", Codegen.T0, Codegen.Z0, resLabel);
